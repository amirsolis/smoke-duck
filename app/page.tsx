    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-purple-50 to-green-50">
      ...
      <section id="vapes" className="py-16 px-4 bg-white/50">
        <div className="container mx-auto">
          ...
          {/* Carrusel de Vapes - Mobile (1 producto por slide) */}
          <div className="relative md:hidden">
            {/* Flechas de navegacion mobile */}
            <button
            ...
            {/* Indicador de pagina mobile */}
            <div className="flex justify-center mt-4 gap-1">
              <span className="text-sm text-gray-600 font-medium">
                {vapesCarouselIndex + 1} / {vapesProducts.length}
              </span>
            </div>
          </div>
          ...
          <div className="relative hidden md:block">
            ...
            <div className="overflow-hidden mx-10">
              <div 
                ...
                style={{ transform: `translateX(-${vapesCarouselIndex * 100}%)` }}
              >
                {/* Agrupar productos en paginas de 4 */}
